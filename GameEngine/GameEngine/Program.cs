...
namespace GameEngine
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //载入物体
            float Elastic = 0.8f; float Friction = 0.5f; //直接Change_Obj_Physics带数就行,这是为了方便
            ...
            Physics.Made_Obj("H", 80, 32, 2, 1, Graph.All_Graphs["l9"]); Physics.Change_Obj_Physics("H", 1, -10, 0, 0, 0, Elastic, Friction); Physics.Change_Obj_Physics_S("H", true, true);
